...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "ti086m1fHIzHSxMojwQRPZGVq", consumerSecret: "soTWyz0E3S2ihD9eJXMMDud1QnUQPmVDB4YryKTzd1SD5RZ3mk")
    var loginSuccess: (() -> ())?
